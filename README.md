...
```bash
clone-gd-addon https://github.com/ChillCube/GridArranger.git
```

## Documentation
You can find the documentation at: https://github.com/ChillCube/GridArranger/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon GridArranger
```
...
- [ItemFrameGrid2D](https://github.com/ChillCube/ItemFrameGrid2D)
